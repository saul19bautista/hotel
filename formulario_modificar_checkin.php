...
// Obtener el ID del check-in a modificar
$id = $_GET['id'];

// Consultar el registro de check-in a modificar
...
if ($result->num_rows > 0) {
    ...
    $fechaCheckin = $row["fecha_checkin"];
    $horaCheckin = $row["hora_checkin"];
} else {
    echo "No se encontró el registro de check-in a modificar";
}
...
<head>
    ...
    <title>Modificar Check-in</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Modificar Check-in</h1>
        <form method="post" action="actualizar_checkin.php" onsubmit="return validarFormulario()">
            ...
            <div class="form-group">
                ...
                <input type="date" id="fecha_checkin" name="fecha_checkin" value="<?php echo $fechaCheckin; ?>" required>
            </div>
            <div class="form-group">
                <label for="hora_checkin">Hora check-in:</label>
                <input type="time" id="hora_checkin" name="hora_checkin" value="<?php echo $horaCheckin; ?>" required>
            </div>
            <button type="submit" name="modificar">Modificar Check-in</button>
        </form>
    </div>
