...
// Obtener el ID de la habitación a modificar
$id = $_POST['id'];

// Redirigir a una página de formulario de modificación con el ID de la habitación en la URL
header("Location: formulario_modificar_habitacion.php?id=$id");
