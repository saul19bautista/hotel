...
<body>
    <div class="container">
        ...
        <form method="POST" action="insertar_checkout.php" onsubmit="return validarFormulario()">
            ...
            <div class="form-group">
                ...
                <input type="time" id="hora_checkout" name="hora_checkout" required>
            </div>
            <button type="submit" name="registrar">Registrar check-out</button>
        </form>
    </div>

    <div class="tabla">
        <h2>Registros de check-Out</h2>
        <a href="tabla_registros_checkout.php">Ver registros de check-Out</a>
    </div>
